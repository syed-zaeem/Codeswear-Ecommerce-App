...
const FormLayoutsSeparatorForUpdate = (props) => {
  // console.log("The props are: " , props.product)
  // ** States
  ...
  const [formdata, setFormdata] = useState({
    ...
    availableQty: props.product.availableQty,
  });
  ...
  const handleSubmitProduct = async (e) => {
    e.preventDefault();
    let response = await dispatch(updateProduct({id: props.product._id, data: formdata}));
    ...
    if (response.payload.success) {
      ...
      toast.error("Error while Editing the Product!", {
        position: "top-left",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  return (
    <Card>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            You can add only one Image for your Product. Please! Paste the Link
            of the Image Here.
          </DialogContentText>
          <TextField
            autoFocus
...
export default FormLayoutsSeparatorForUpdate;
